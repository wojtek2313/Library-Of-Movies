...
public protocol URLFactoryProtocol {
    func create(_ responderType: ResponderType, withParameter parameter: String?) -> URL?
}

public struct URLFactory: URLFactoryProtocol {
    // MARK: - Public Methods
    
    public func create(_ responderType: ResponderType, withParameter parameter: String? = nil) -> URL? {
        ...
        components.queryItems = responderType.queryItems
